    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Detail Riwayat Perjalanan Dinas') }}
            </h2>
                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-1">
                            ...
                            <div>
                                <span class="inline-flex items-center px-3 py-1 rounded-lg text-sm font-medium bg-blue-50 text-blue-800 border border-blue-200">
                                    {{ $user->dataDiri ? ucwords($user->dataDiri->unit_kerja) : '-' }}
                                </span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-1">
                            ...
                            <div>
                                <span class="inline-flex items-center px-3 py-1 rounded-lg text-sm font-medium bg-green-50 text-green-800 border border-green-200">
                                    {{ $sppd->kota ?? '-' }}
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="space-y-1">
                            ...
                            <p class="text-base text-gray-900">
                                {{ $sppd->tg_berangkat ? \Carbon\Carbon::parse($sppd->tg_berangkat)->translatedFormat('d F Y') : '-' }}
                            </p>
                        </div>
                        ...
                        <div class="space-y-1">
                            ...
                            <p class="text-base text-gray-900">
                                {{ $sppd->tg_pulang ? \Carbon\Carbon::parse($sppd->tg_pulang)->translatedFormat('d F Y') : '-' }}
                            </p>
                        </div>
                        ...
                        <div class="space-y-1">
                            ...
                            <div>
                                @php
                                    ...
                                    $colorClass = $angkutanColors[$angkutan] ?? 'bg-gray-100 text-gray-800 border-gray-200';
                                @endphp
                                <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium border {{ $colorClass }}">
                                    {{ ucfirst($angkutan) }}
                                </span>
            ...
            <div class="bg-white overflow-hidden shadow-lg sm:rounded-lg">
                <div class="p-6">
                    <div class="mb-6 pb-4 border-b-2 border-gray-100">
                        ...
                        <p class="text-sm text-gray-500 mt-1 ml-8">Rincian biaya yang dikeluarkan selama perjalanan dinas</p>
                    </div>
                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <span class="text-2xl mr-3">🚖</span>
                                            <div>
                                                <div class="text-sm font-medium text-gray-900">Transport Lokal (Pergi)</div>
                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <span class="text-2xl mr-3">🚕</span>
                                            <div>
                                                <div class="text-sm font-medium text-gray-900">Transport Lokal (Pulang)</div>
                                ...
                                <tr class="bg-green-50 border-t-2 border-green-200">
                                    <td class="px-6 py-5 whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            <div>
                                                <div class="text-base font-bold text-green-900 uppercase">Total Biaya SPPD</div>
